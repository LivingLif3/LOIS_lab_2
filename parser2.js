export class Parser {
    ...
    */
    ...
    changeLogicalConclusions() {
        this.logicalConclusions = this.logicalConclusions.map((item) => {
            return {name: item.name, logicalConclusion: this.parseLogicalConclusionElement(item.logicalConclusion)}
        })
    }
    ...
    filterLogicalConclusions() {
        this.logicalConclusions = this.logicalConclusions.filter((item) => {
            if (item.logicalConclusion[0] && item.logicalConclusion[1]) return item
        })
    }
    ...
    startParser(){
        ...
        this.parseRules()
        this.changeLogicalConclusions()
        this.changeRules()
        this.filterLogicalConclusions()
